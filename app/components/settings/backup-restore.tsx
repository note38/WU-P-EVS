...
export function BackupRestore() {
  ...
  const handleRestore = async () => {
    ...
    try {
      ...
      console.log("Restore API response:", response.status, response.statusText);
      ...
      toast({
        ...
        description: error.message || "There was an error restoring the backup. Please check the console for details.",
        variant: "destructive",
      });
    } finally {
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Download a complete backup of your system data including elections, voters, and settings.
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Upload a backup file to restore your system data. This will overwrite current data.
            </p>
          </div>
