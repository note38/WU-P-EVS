...
# Read file list for this chunk
chunk_file = f'graphify-out/.graphify_chunk_{chunk_index:02d}.txt'
...
prompt = prompt_template.replace('CHUNK_NUM', str(chunk_index + 1))  # 1-indexed
